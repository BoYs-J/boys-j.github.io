function ZeroWeather(data) {
    try {
        let origin = data.parentElement.querySelector(".s-sticker").outerHTML
        document.querySelector('.nav-plugin-simple').innerHTML = origin
    } catch (error) {
